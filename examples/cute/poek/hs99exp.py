...
x1 = model.add_variable(lb=0.0, ub=1.58, value=0.5)
r1 = model.add_variable(lb=0.0, ub=0.0)
q1 = model.add_variable(lb=0.0, ub=0.0)
s1 = model.add_variable(lb=0.0, ub=0.0)
x2 = model.add_variable(lb=0.0, ub=1.58, value=0.5)
r2 = model.add_variable()
q2 = model.add_variable()
s2 = model.add_variable()
x3 = model.add_variable(lb=0.0, ub=1.58, value=0.5)
r3 = model.add_variable()
q3 = model.add_variable()
s3 = model.add_variable()
x4 = model.add_variable(lb=0.0, ub=1.58, value=0.5)
r4 = model.add_variable()
q4 = model.add_variable()
s4 = model.add_variable()
x5 = model.add_variable(lb=0.0, ub=1.58, value=0.5)
r5 = model.add_variable()
q5 = model.add_variable()
s5 = model.add_variable()
x6 = model.add_variable(lb=0.0, ub=1.58, value=0.5)
r6 = model.add_variable()
q6 = model.add_variable()
s6 = model.add_variable()
x7 = model.add_variable(lb=0.0, ub=1.58, value=0.5)
r7 = model.add_variable()
q7 = model.add_variable()
s7 = model.add_variable()
r8 = model.add_variable()
