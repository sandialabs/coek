...
extern "C" void* variable_create(double lb, double ub, double init, bool binary, bool integer, const char* name)
{
...
extern "C" void* expression_create()
{
return new coek::Expression();
}
