...
public:
    ...
    //virtual void initialize(NumericValue* e);
};


class LinearExprRepn : public ExprRepn
{
public:
...
class QuadraticExprRepn : public LinearExprRepn
{
public:
...
class NonlinearExprRepn : public LinearExprRepn
{
public:
