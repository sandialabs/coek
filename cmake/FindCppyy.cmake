...
if (NOT CMAKE_CPPYY_SOURCE_DIR)
    set(CMAKE_CPPYY_SOURCE_DIR ${CMAKE_SOURCE_DIR})
endif()
...
function(cppyy_generate_setup pkg version lib_so_file rootmap_file pcm_file map_file)
    ...
    configure_file(${CMAKE_CPPYY_SOURCE_DIR}/pkg_templates/setup.py.in ${SETUP_PY_FILE})
...
function(cppyy_generate_init)
    ...
    configure_file(${CMAKE_CPPYY_SOURCE_DIR}/pkg_templates/__init__.py.in ${INIT_PY_FILE})
...
function(cppyy_add_bindings pkg pkg_version author author_email)
    ...
    if("${ARG_LICENSE_FILE}" STREQUAL "")
        set(ARG_LICENSE_FILE ${CMAKE_CPPYY_SOURCE_DIR}/LICENSE)
    endif()
    set(LICENSE_FILE ${ARG_LICENSE_FILE})

    if("${ARG_README_FILE}" STREQUAL "")
        set(ARG_README_FILE ${CMAKE_CPPYY_SOURCE_DIR}/README.rst)
    endif()
    ...
    configure_file(${CMAKE_CPPYY_SOURCE_DIR}/pkg_templates/setup.cfg.in ${setup_cfg})
    ...
    #
    set(PKG ${pkg})
    configure_file(${CMAKE_CPPYY_SOURCE_DIR}/pkg_templates/test_bindings.py.in ${pkg_dir}/tests/test_bindings.py)

    #
    # Generate MANIFEST.in 
    #
    configure_file(${CMAKE_CPPYY_SOURCE_DIR}/pkg_templates/MANIFEST.in.in ${CMAKE_CURRENT_BINARY_DIR}/MANIFEST.in)

    #
    # Copy pure python code
    #
    file(COPY ${CMAKE_CPPYY_SOURCE_DIR}/py/ DESTINATION ${pkg_dir}
