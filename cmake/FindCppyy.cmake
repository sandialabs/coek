...
function(cppyy_generate_init)
    ...
    if(NOT "${ARG_NAMESPACES}" STREQUAL "")
        string(FIND "${ARG_NAMESPACES}" ";" _found_semicolon)
        if(${_found_semicolon} EQUAL -1)
            set(NAMESPACE_INJECTIONS "from cppyy.gbl import ${ARG_NAMESPACES}")
        else()
...
function(cppyy_add_bindings pkg pkg_version author author_email)
  ...
  ####################################################
    ...
    set_property(TARGET ${lib_name} PROPERTY VERSION ${pkg_version})
