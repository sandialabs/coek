...
public:
    ...
    DefaultProductSetIteratorRepn(ProductSet* _ref, const std::vector<IndexParameter>& _indices, bool _done=false)
    ...
    DefaultProductSetIteratorRepn(ProductSet* _ref, bool _done=false)
        : ref(_ref), done(_done)
        {
...
ProductSet::ProductSet(const std::shared_ptr<BaseSetExpression>& _lhs, const std::shared_ptr<BaseSetExpression>& _rhs)
    : BaseSetExpression()
{
...
ProductSet::ProductSet(const std::shared_ptr<ProductSet>& _lhs, const std::shared_ptr<BaseSetExpression>& _rhs)
    : BaseSetExpression()
{
this->_finite = _lhs->_finite and _rhs->_finite;
this->_countable = _lhs->_countable and _rhs->_countable;
...
ProductSet::ProductSet(const std::shared_ptr<BaseSetExpression>& _lhs, const std::shared_ptr<ProductSet>& _rhs)
    : BaseSetExpression()
{
this->_finite = _lhs->_finite and _rhs->_finite;
this->_countable = _lhs->_countable and _rhs->_countable;
...
ProductSet::ProductSet(const std::shared_ptr<ProductSet>& _lhs, const std::shared_ptr<ProductSet>& _rhs)
    : BaseSetExpression()
{
this->_finite = _lhs->_finite and _rhs->_finite;
this->_countable = _lhs->_countable and _rhs->_countable;
...
std::shared_ptr<SetIteratorRepnBase<std::vector<set_types>>> ProductSet::begin_NDiterator(const std::vector<IndexParameter>& indices)
{
auto tmp = std::make_shared<DefaultProductSetIteratorRepn>(this, indices);
return tmp;
}
...
std::shared_ptr<BaseSetExpression> ProductSet::set_union(const std::shared_ptr<BaseSetExpression>& lhs, const std::shared_ptr<BaseSetExpression>& rhs) const
{
if (rhs->dim() != _dim)
    throw std::runtime_error("Cannot take the union of product sets with different dimensions.");
auto tmp = std::make_shared<ProductSetUnion>(
    std::dynamic_pointer_cast<ProductSet>(lhs),
    std::dynamic_pointer_cast<ProductSet>(rhs));
return tmp;
}

std::shared_ptr<BaseSetExpression> ProductSet::set_intersection(const std::shared_ptr<BaseSetExpression>& lhs, const std::shared_ptr<BaseSetExpression>& rhs) const
{
if (rhs->dim() != _dim)
    throw std::runtime_error("Cannot take the intersection of product sets with different dimensions.");
auto tmp = std::make_shared<ProductSetIntersection>(
                std::dynamic_pointer_cast<ProductSet>(lhs),
                std::dynamic_pointer_cast<ProductSet>(rhs));
return tmp;
}

std::shared_ptr<BaseSetExpression> ProductSet::set_difference(const std::shared_ptr<BaseSetExpression>& lhs, const std::shared_ptr<BaseSetExpression>& rhs) const
{
if (rhs->dim() != _dim)
    throw std::runtime_error("Cannot take the difference of product sets with different dimensions.");
auto tmp = std::make_shared<ProductSetDifference>(
                std::dynamic_pointer_cast<ProductSet>(lhs),
                std::dynamic_pointer_cast<ProductSet>(rhs));
return tmp;
}

std::shared_ptr<BaseSetExpression> ProductSet::set_symmetric_difference(const std::shared_ptr<BaseSetExpression>& lhs, const std::shared_ptr<BaseSetExpression>& rhs) const
{
if (rhs->dim() != _dim)
    throw std::runtime_error("Cannot take the symmetric difference of product sets with different dimensions.");
...
std::shared_ptr<BaseSetExpression> ProductSet::set_product(const std::shared_ptr<BaseSetExpression>& lhs, const std::shared_ptr<BaseSetExpression>& rhs) const
{
if (rhs->dim() == 1) {
    auto tmp = std::make_shared<ProductSet>(
                std::dynamic_pointer_cast<ProductSet>(lhs), rhs);
    return tmp;
    }
else {
    auto tmp = std::make_shared<ProductSet>(
...
public:
    ...
    FiniteProductSetIteratorRepn(const typename std::vector<std::vector<set_types>>::iterator& _iterator)
        : iterator(_iterator)
        {}
...
ProductSetUnion::ProductSetUnion(const std::shared_ptr<ProductSet>& _lhs, const std::shared_ptr<ProductSet>& _rhs)
: lhs(_lhs), rhs(_rhs)
{
...
ProductSetIntersection::ProductSetIntersection(const std::shared_ptr<ProductSet>& _lhs, const std::shared_ptr<ProductSet>& _rhs)
: lhs(_lhs), rhs(_rhs)
{
assert(_lhs->dim() == _rhs->dim());
_dim = _lhs->dim();
...
ProductSetDifference::ProductSetDifference(const std::shared_ptr<ProductSet>& _lhs, const std::shared_ptr<ProductSet>& _rhs)
: lhs(_lhs), rhs(_rhs)
{
assert(_lhs->dim() == _rhs->dim());
_dim = _lhs->dim();
...
ProductSetSymmetricDifference::ProductSetSymmetricDifference(const std::shared_ptr<ProductSet>& _lhs, const std::shared_ptr<ProductSet>& _rhs)
: lhs(_lhs), rhs(_rhs)
{
assert(_lhs->dim() == _rhs->dim());
_dim = _lhs->dim();
