...
model.add_objective( -a[1] - a[2]*x[1] - a[3]*x[1]*x[2]\
        - a[4]*x[1]*x[3] - a[5]*x[1]*x[4]\
        - a[6]*x[1]*x[5] )

model.add_constraint( pk.inequality(0, a[7]*x[1] + a[8]*x[1]*x[2]\
             + a[9]*x[1]*x[3] + a[10]*x[1]*x[4]\
             + a[11]*x[1]*x[5], 294000.0) )

model.add_constraint( pk.inequality(0, a[12]*x[1] + a[13]*x[1]*x[2]\
             + a[14]*x[1]*x[3] + a[15]*x[1]*x[4]\
             + a[16]*x[1]*x[5], 294000.0) )

model.add_constraint( pk.inequality(0, a[17]*x[1] + a[18]*x[1]*x[2]\
