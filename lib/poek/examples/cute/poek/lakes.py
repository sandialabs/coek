...
model.add_objective(
    (t1_1 - 202761.072) * (t1_1 - 202761.072)
    + (o1_1 - 232.252) * (o1_1 - 232.252)
    + (t1_2 - 277791.816) * (t1_2 - 277791.816)
    + (o1_2 - 174.665) * (o1_2 - 174.665)
    + (t1_3 - 2636.996) * (t1_3 - 2636.996)
    + (o1_3 - 180.539) * (o1_3 - 180.539)
    + (t1_4 - 59987.0235) * (t1_4 - 59987.0235)
    + (o1_4 - 211.558) * (o1_4 - 211.558)
    + (t1_5 - 19490.4) * (t1_5 - 19490.4)
    + (o1_5 - 232.252) * (o1_5 - 232.252)
    + (t2_1 - 202703.646) * (t2_1 - 202703.646)
    + (o2_1 - 83.789) * (o2_1 - 83.789)
    + (t2_2 - 277849.512) * (t2_2 - 277849.512)
    + (o2_2 - 173.255) * (o2_2 - 173.255)
    + (t2_3 - 2638.1) * (t2_3 - 2638.1)
    + (o2_3 - 179.917) * (o2_3 - 179.917)
    + (t2_4 - 59998.59) * (t2_4 - 59998.59)
    + (o2_4 - 210.585) * (o2_4 - 210.585)
    + (t2_5 - 19555.2) * (t2_5 - 19555.2)
    + (o2_5 - 215.254) * (o2_5 - 215.254)
    + (t3_1 - 202720.536) * (t3_1 - 202720.536)
    + (o3_1 - 82.916) * (o3_1 - 82.916)
    + (t3_2 - 277955.288) * (t3_2 - 277955.288)
    + (o3_2 - 173.721) * (o3_2 - 173.721)
    + (t3_3 - 2639.894) * (t3_3 - 2639.894)
    + (o3_3 - 182.676) * (o3_3 - 182.676)
    + (t3_4 - 60046.959) * (t3_4 - 60046.959)
    + (o3_4 - 207.838) * (o3_4 - 207.838)
    + (t3_5 - 19597.6) * (t3_5 - 19597.6)
    + (o3_5 - 203.855) * (o3_5 - 203.855)
    + (t4_1 - 202808.364) * (t4_1 - 202808.364)
    + (o4_1 - 80.134) * (o4_1 - 80.134)
    + (t4_2 - 278104.336) * (t4_2 - 278104.336)
    + (o4_2 - 178.654) * (o4_2 - 178.654)
    + (t4_3 - 2640.906) * (t4_3 - 2640.906)
    + (o4_3 - 185.917) * (o4_3 - 185.917)
    + (t4_4 - 60074.298) * (t4_4 - 60074.298)
    + (o4_4 - 206.416) * (o4_4 - 206.416)
    + (t4_5 - 19652.8) * (t4_5 - 19652.8)
    + (o4_5 - 186.308) * (o4_5 - 186.308)
    + (t5_1 - 202916.46) * (t5_1 - 202916.46)
    + (o5_1 - 65.345) * (o5_1 - 65.345)
    + (t5_2 - 278224.536) * (t5_2 - 278224.536)
    + (o5_2 - 188.01) * (o5_2 - 188.01)
    + (t5_3 - 2641.458) * (t5_3 - 2641.458)
    + (o5_3 - 192.568) * (o5_3 - 192.568)
    + (t5_4 - 60091.122) * (t5_4 - 60091.122)
    + (o5_4 - 204.3) * (o5_4 - 204.3)
    + (t5_5 - 19708.8) * (t5_5 - 19708.8)
    + (o5_5 - 201.1) * (o5_5 - 201.1)
    + (t6_1 - 202953.618) * (t6_1 - 202953.618)
    + (o6_1 - 72.005) * (o6_1 - 72.005)
    + (t6_2 - 278277.424) * (t6_2 - 278277.424)
    + (o6_2 - 193.833) * (o6_2 - 193.833)
    + (t6_3 - 2641.458) * (t6_3 - 2641.458)
    + (o6_3 - 196.651) * (o6_3 - 196.651)
    + (t6_4 - 60082.71) * (t6_4 - 60082.71)
    + (o6_4 - 204.25) * (o6_4 - 204.25)
    + (t6_5 - 19706.4) * (t6_5 - 19706.4)
    + (o6_5 - 241.079) * (o6_5 - 241.079)
)
