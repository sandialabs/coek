...
model.add_objective( x[3]-1 + x[1]**2+x[2]**2 + (x[3]+x[4])**2 + sin(x[3])**2 + x[1]**2*x[2]**2 + x[4]-3 +\
    sin(x[3])**2 + (x[4]-1)**2 +(x[2]**2)**2+(x[3]**2 + (x[4]+x[1])**2)**2 +\
    (x[1]-4 + sin(x[4])**2 + x[2]**2*x[3]**2)**2 +sin(x[4])**4)

model.add_constraint(x[2]>=1)

model.add_constraint(pk.inequality(-1e+10,x[3],1.0))
