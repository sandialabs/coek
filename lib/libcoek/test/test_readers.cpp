...
TEST_CASE( "jpof_reader_string", "[smoke]" ) {
  ...
  SECTION( "small1" ) {
    ...
    static std::list<std::string> con_expr = {"[", "==", "[", "pow", "y", std::to_string(2.000), "]", std::to_string(4.000), "]"};
...
TEST_CASE( "jpof_reader_file", "[smoke]" ) {
  ...
  SECTION( "small1" ) {
    ...
    test_con(model, 0, {"[", "==", "[", "pow", "y", std::to_string(2.0), "]", std::to_string(4.0), "]"}, "CON1");
    }
  ...
  SECTION( "small5" ) {
    ...
    test_obj(model, 0, {"[", "min", "[", "+", "[", "/", "[", "pow", "x", std::to_string(2.0), "]", std::to_string(2.0), "]", "[", "/", "[", "pow",   "x", std::to_string(2.0), "]", "q", "]", "]", "]"}, "OBJ");

    test_con(model, 0, {"[", "==", "[", "*", "[", "*", std::to_string(0.5), "v", "]", "[", "+", "x", "[", "*",
  std::to_string(-1.0), "y", "]", "]", "]", std::to_string(2.0), "]"}, "CON1");
    test_con(model, 1, {"[", "==", "[", "*", "v", "[", "+", "[", "*", "[", "/", std::to_string(1.0), "q", "]",
  "x", "]", "[", "*", "[", "-", "[", "/", std::to_string(1.0), "q", "]", "]", "y", "]", "]", "]", std::to_string(2.0), "]"}, "CON10");
    test_con(model, 2, {"[", "==", "[", "*", "[", "*", "v", "[", "+", "x", "[", "*", std::to_string(-1.0), "y",
  "]", "]", "]", "[", "/", std::to_string(1.0), "q", "]", "]", std::to_string(2.0), "]"}, "CON11");
    test_con(model, 3, {"[", "==", "[", "*", "v", "[", "+", "x", "[", "*", std::to_string(-1.0), "y", "]", "]",
  "]", "[", "*", std::to_string(2.0), "q", "]", "]"}, "CON12");
    test_con(model, 4, {"[", "==", "[", "*", "[", "*", std::to_string(0.5), "v", "]", "[", "+", "x", "[", "*",
  std::to_string(-1.0), "y", "]", "]", "]", std::to_string(2.0), "]"}, "CON2");
    test_con(model, 5, {"[", "==", "[", "/", "[", "*", "v", "[", "+", "x", "[", "*", std::to_string(-1.0), "y",
  "]", "]", "]", std::to_string(2.0), "]", std::to_string(2.0), "]"}, "CON3");
    test_con(model, 6, {"[", "==", "[", "*", "v", "[", "+", "[", "*", std::to_string(0.5), "x", "]", "[", "*",
  std::to_string(-0.500), "y", "]", "]", "]", std::to_string(2.0), "]"}, "CON4");
    test_con(model, 7, {"[", "==", "[", "*", "[", "*", "v", "[", "+", "x", "[", "*", std::to_string(-1.0), "y",
  "]", "]", "]", std::to_string(0.5), "]", std::to_string(2.0), "]"}, "CON5");
    test_con(model, 8, {"[", "==", "[", "*", "v", "[", "+", "x", "[", "*", std::to_string(-1.0), "y", "]", "]",
  "]", std::to_string(4.0), "]"}, "CON6");
    test_con(model, 9, {"[", "==", "[", "*", "[", "*", "[", "/", std::to_string(1.0), "q", "]", "v", "]", "[",
  "+", "x", "[", "*", std::to_string(-1.0), "y", "]", "]", "]", std::to_string(2.0), "]"}, "CON7");
    test_con(model, 10, {"[", "==", "[", "*", "[", "*", "[", "/", std::to_string(1.0), "q", "]", "v", "]", "[",
  "+", "x", "[", "*", std::to_string(-1.0), "y", "]", "]", "]", std::to_string(2.0), "]"}, "CON8");
    test_con(model, 11, {"[", "==", "[", "/", "[", "*", "v", "[", "+", "x", "[", "*", std::to_string(-1.0), "y",
  "]", "]", "]", "q", "]", std::to_string(2.0), "]"}, "CON9");
    }
  ...
  SECTION( "small5a" ) {
    ...
    test_con(model, 0, {"[", "<=", "-Inf", "[", "+", "x", "y", "]", "[", "*", std::to_string(2.0), "q", "]", "]"}, "CON1");
    test_con(model, 1, {"[", "<=", "q", "[", "+", "x", "y", "]", "Inf", "]"}, "CON2");
    test_con(model, 2, {"[", "<=", "q", "[", "+", "x", "y", "]", "[", "*", std::to_string(2.0), "q", "]", "]"}, "CON3");
    }
  ...
  SECTION( "small6" ) {
    ...
    test_con(model, 0, {"[", "==", "[", "*", "[", "*", "[", "/", std::to_string(1.0), "p", "]", "v", "]", "[",
  "+", "x", "[", "*", std::to_string(-1.0), "y", "]", "]", "]", std::to_string(2.0), "]"}, "CON1");
    test_con(model, 1, {"[", "==", "[", "*", "[", "/", "v", "p", "]", "[", "+", "x", "[", "*", std::to_string(-1.0), "y", "]", "]", "]", std::to_string(2.0), "]"}, "CON2");
    test_con(model, 2, {"[", "==", "[", "/", "[", "*", "v", "[", "+", "x", "[", "*", std::to_string(-1.0), "y",
  "]", "]", "]", "p", "]", std::to_string(2.0), "]"}, "CON3");
    test_con(model, 3, {"[", "==", "[", "*", "v", "[", "+", "[", "/", "x", "p", "]", "[", "-", "[",
  "/", "y", "p", "]", "]", "]", "]", std::to_string(2.0), "]"}, "CON4");
    test_con(model, 4, {"[", "==", "[", "*", "[", "*", "v", "[", "+", "x", "[", "*", std::to_string(-1.0), "y",
  "]", "]", "]", "[", "/", std::to_string(1.0), "p", "]", "]", std::to_string(2.0), "]"}, "CON5");
    test_con(model, 5, {"[", "==", "[", "+", "[", "*", "v", "[", "+", "x", "[", "*", std::to_string(-1.0), "y",
  "]", "]", "]", "[", "*", std::to_string(-2.0), "p", "]", "]", std::to_string(0.0), "]"}, "CON6");
    }
  ...
  SECTION( "small7" ) {
    ...
    test_con(model, 0, {"[", "==", "[", "*", "[", "*", "[", "/", "[", "/", std::to_string(1.0), "p", "]", std::to_string(2.0), "]", "v", "]", "[", "+", "x", "[", "*", std::to_string(-1.0), "y", "]", "]", "]", std::to_string(2.0), "]"}, "CON1a");
    test_con(model, 1, {"[", "==", "[", "*", "[", "*", "[", "/", std::to_string(1.0), "[", "*", std::to_string(2.0), "p", "]", "]", "v", "]", "[", "+", "x", "[", "*", std::to_string(-1.0), "y", "]", "]", "]", std::to_string(2.0), "]"}, "CON1b");
    test_con(model, 2, {"[", "==", "[", "*", "[", "*", "[", "/", std::to_string(1.0), "[", "+", "p", std::to_string(2.0), "]", "]", "v", "]", "[", "+", "x", "[", "*", std::to_string(-1.0), "y", "]", "]", "]", std::to_string(2.0), "]"}, "CON1c");
    test_con(model, 3, {"[", "==", "[", "*", "[", "*", "[", "/", std::to_string(1.0), "[", "pow", "[", "+", "p", std::to_string(2.0), "]", std::to_string(2.0), "]", "]", "v", "]", "[", "+", "x", "[", "*", std::to_string(-1.0), "y", "]", "]", "]", std::to_string(2.0), "]"}, "CON1d");

    test_con(model, 4, {"[", "==", "[", "*", "[", "/", "[", "/", "v", "p", "]", "p", "]", "[", "+", "x", "[", "*", std::to_string(-1.0), "y", "]", "]", "]", std::to_string(2.0), "]"}, "CON2a");
    test_con(model, 5, {"[", "==", "[", "*", "[", "/", "v", "[", "*", "p", "p", "]", "]", "[", "+", "x", "[", "*", std::to_string(-1.0), "y", "]", "]", "]", std::to_string(2.0), "]"}, "CON2b");
    test_con(model, 6, {"[", "==", "[", "*", "[", "/", "v", "[", "+", "p", "p", "]", "]", "[", "+", "x", "[", "*", std::to_string(-1.0), "y", "]", "]", "]", std::to_string(2.0), "]"}, "CON2c");
    test_con(model, 7, {"[", "==", "[", "*", "[", "/", "v", "[", "pow", "[", "+", "p", "p", "]", std::to_string(2.0), "]", "]", "[", "+", "x", "[", "*", std::to_string(-1.0), "y", "]", "]", "]", std::to_string(2.0), "]"}, "CON2d");

    test_con(model, 8, {"[", "==", "[", "/", "[", "/", "[", "*", "v", "[", "+", "x", "[", "*", std::to_string(-1.0), "y", "]", "]", "]", "p", "]", std::to_string(2.0), "]", std::to_string(2.0), "]"}, "CON3a");
    test_con(model, 9, {"[", "==", "[", "/", "[", "*", "v", "[", "+", "x", "[", "*", std::to_string(-1.0), "y", "]", "]", "]", "[", "*", std::to_string(2.0), "p", "]", "]", std::to_string(2.0), "]"}, "CON3b");
    test_con(model, 10, {"[", "==", "[", "/", "[", "*", "v", "[", "+", "x", "[", "*", std::to_string(-1.0), "y", "]", "]", "]", "[", "+", "p", std::to_string(2.0), "]", "]", std::to_string(2.0), "]"}, "CON3c");
    test_con(model, 11, {"[", "==", "[", "/", "[", "*", "v", "[", "+", "x", "[", "*", std::to_string(-1.0), "y", "]", "]", "]", "[", "pow", "[", "+", "p", std::to_string(2.0), "]", std::to_string(2.0), "]", "]", std::to_string(2.0), "]"}, "CON3d");

    test_con(model, 12, {"[", "==", "[", "*", "v", "[", "+", "[", "/", "[", "/", "x", "p", "]", std::to_string(2.0), "]", "[", "-", "[", "/", "[", "/", "y", "p", "]", std::to_string(2.0), "]", "]", "]", "]", std::to_string(2.0), "]"}, "CON4a");
    test_con(model, 13, {"[", "==", "[", "*", "v", "[", "+", "[", "/", "x", "[", "*", std::to_string(2.0), "p", "]", "]", "[", "-", "[", "/", "y", "[", "*", std::to_string(2.0), "p", "]", "]", "]", "]", "]", std::to_string(2.0), "]"}, "CON4b");
    test_con(model, 14, {"[", "==", "[", "*", "v", "[", "+", "[", "/", "x", "[", "+", "p", std::to_string(2.0), "]", "]", "[", "-", "[", "/", "y", "[", "+", "p", std::to_string(2.0), "]", "]", "]", "]", "]", std::to_string(2.0), "]"}, "CON4c");
    test_con(model, 15, {"[", "==", "[", "*", "v", "[", "+", "[", "/", "x", "[", "pow", "[", "+", "p", std::to_string(2.0), "]", std::to_string(2.0), "]", "]", "[", "-", "[", "/", "y", "[", "pow", "[", "+", "p", std::to_string(2.0), "]", std::to_string(2.0), "]", "]", "]", "]", "]", std::to_string(2.0), "]"}, "CON4d");

    test_con(model, 16, {"[", "==", "[", "*", "[", "*", "v", "[", "+", "x", "[", "*", std::to_string(-1.0), "y", "]", "]", "]", "[", "/", "[", "/", std::to_string(1.0), "p", "]", std::to_string(2.0), "]", "]", std::to_string(2.0), "]"}, "CON5a");
    test_con(model, 17, {"[", "==", "[", "*", "[", "*", "v", "[", "+", "x", "[", "*", std::to_string(-1.0), "y", "]", "]", "]", "[", "/", std::to_string(1.0), "[", "*", std::to_string(2.0), "p", "]", "]", "]", std::to_string(2.0), "]"}, "CON5b");
    test_con(model, 18, {"[", "==", "[", "*", "[", "*", "v", "[", "+", "x", "[", "*", std::to_string(-1.0), "y", "]", "]", "]", "[", "/", std::to_string(1.0), "[", "+", "p", std::to_string(2.0), "]", "]", "]", std::to_string(2.0), "]"}, "CON5c");
    test_con(model, 19, {"[", "==", "[", "*", "[", "*", "v", "[", "+", "x", "[", "*", std::to_string(-1.0), "y", "]", "]", "]", "[", "/", std::to_string(1.0), "[", "pow", "[", "+", "p", std::to_string(2.0), "]", std::to_string(2.0), "]", "]", "]", std::to_string(2.0), "]"}, "CON5d");

    test_con(model, 20, {"[", "==", "[", "+", "[", "*", "v", "[", "+", "x", "[", "*", std::to_string(-1.0), "y", "]", "]", "]", "[", "*", std::to_string(-4.0), "p", "]", "]", std::to_string(0.0), "]"}, "CON6a");
    test_con(model, 21, {"[", "==", "[", "+", "[", "*", "v", "[", "+", "x", "[", "*", std::to_string(-1.0), "y", "]", "]", "]", "[", "*", std::to_string(-4.0), "p", "]", "]", std::to_string(0.0), "]"}, "CON6b");
    test_con(model, 22, {"[", "==", "[", "+", "[", "*", "v", "[", "+", "x", "[", "*", std::to_string(-1.0), "y", "]", "]", "]", "[", "-", "[", "*", std::to_string(2.0), "[", "+", "p", std::to_string(2.0), "]", "]", "]", "]", std::to_string(0.0), "]"}, "CON6c");
    test_con(model, 23, {"[", "==", "[", "+", "[", "*", "v", "[", "+", "x", "[", "*", std::to_string(-1.0), "y", "]", "]", "]", "[", "-", "[", "*", std::to_string(2.0), "[", "pow", "[", "+", "p", std::to_string(2.0), "]", std::to_string(2.0), "]", "]", "]", "]", std::to_string(0.0), "]"}, "CON6d");
    }
  ...
  std::to_string(1.0), "]"}, "con1");
    test_con(model, 1, {"[", "==", "[", "+", "[", "*", "[", "*", "p", "x", "]", "z", "]", "x", "]",
  std::to_string(1.0), "]"}, "con2");
    test_con(model, 2, {"[", "==", "x", std::to_string(1.0), "]"}, "con3");
    test_con(model, 3, {"[", "==", "[", "*", "[", "*", "x", "y", "]", "z", "]", std::to_string(1.0), "]"}, "con4");
    test_con(model, 4, {"[", "==", "[", "*", "[", "*", "p", "x", "]", "z", "]", std::to_string(1.0), "]"}, "con5");
    }
  ...
  SECTION( "small10" ) {
    ...
    test_obj(model, 0, {"[", "min", "[", "+", "[", "*", "x", "y", "]", "[", "*", "z", "y", "]", "[", "*", "p", "y", "]", "[", "*", "[", "*", "y", "y", "]", "p", "]", "[", "*", "[", "*", "y", "y", "]", "z", "]", "[", "*", "z", "[", "pow", "y", std::to_string(2.0), "]", "]", "]", "]"}, "obj");

    test_con(model, 0, {"[", "==", "[", "*", "x", "y", "]", std::to_string(0.0), "]"}, "con1");
    test_con(model, 1, {"[", "==", "[", "*", "p", "[", "pow", "y", std::to_string(2.0), "]", "]", std::to_string(0.0), "]"}, "con12");
    test_con(model, 2, {"[", "==", "[", "*", "[", "*", "p", "y", "]", "x", "]", std::to_string(0.0), "]"}, "con13");
    test_con(model, 3, {"[", "==", "[", "*", "z", "[", "pow", "y", std::to_string(2.0), "]", "]", std::to_string(0.0), "]"}, "con14");
    test_con(model, 4, {"[", "==", "[", "*", "[", "*", "z", "y", "]", "x", "]", std::to_string(0.0), "]"}, "con15");
    test_con(model, 5, {"[", "==", "[", "*", "p", "y", "]", std::to_string(0.0), "]"}, "con17");
    test_con(model, 6, {"[", "==", "[", "+", "[", "*", "z", "y", "]", "y", "]", std::to_string(0.0), "]"}, "con2");
    test_con(model, 7, {"[", "==", "y", std::to_string(0.0), "]"}, "con3");
    test_con(model, 8, {"[", "==", "y", std::to_string(0.0), "]"}, "con4");
    test_con(model, 9, {"[", "==", "[", "+", "[", "*", "p", "[", "pow", "y", std::to_string(2.0), "]", "]", "y", "]", std::to_string(0.0), "]"}, "con5");
    test_con(model, 10, {"[", "==", "[", "+", "[", "*", "[", "*", "p", "y", "]", "x", "]", "y", "]", std::to_string(0.0), "]"}, "con6");
    test_con(model, 11, {"[", "==", "[", "+", "[", "*", "z", "[", "pow", "y", std::to_string(2.0), "]", "]", "y", "]", std::to_string(0.0), "]"}, "con7");
    test_con(model, 12, {"[", "==", "[", "+", "[", "*", "[", "*", "z", "y", "]", "x", "]", "y", "]", std::to_string(0.0), "]"}, "con8");
  ...
  SECTION( "small11" ) {
    ...
    test_con(model, 0, {"[", "<=", std::to_string(-1.0), "x[1,1]", std::to_string(1.0), "]"}, "var_bnd[1]");
    test_con(model, 1, {"[", "<=", std::to_string(-1.0), "x[1,2]", std::to_string(1.0), "]"}, "var_bnd[2]");
    test_con(model, 2, {"[", "<=", std::to_string(-1.0), "x[1,3]", std::to_string(1.0), "]"}, "var_bnd[3]");
    }
  ...
  SECTION( "small13" ) {
    ...
    test_con(model, 0, {"[", "==", "[", "+", "[", "pow", "x", std::to_string(3.000), "]", "[", "*", std::to_string(-1.0), "x", "]", "]", std::to_string(0.0), "]"}, "c1");
    test_con(model, 1, {"[", "==", "[", "*", std::to_string(10.000), "[", "+", "[", "pow", "x", std::to_string(3.0), "]", "[", "*", std::to_string(-1.0), "x", "]", "]", "]", std::to_string(0.0), "]"}, "c2");
    test_con(model, 2, {"[", "==", "[", "/", "[", "+", "[", "pow", "x", std::to_string(3.0), "]", "[", "*", std::to_string(-1.0), "x", "]", "]", std::to_string(10.0), "]", std::to_string(0.0), "]"}, "c3");
    }
  ...
  SECTION( "small14" ) {
    ...
    test_con(model, 1, {"[", "==", "[", "acos", "ZERO", "]", std::to_string(1.570796), "]"}, "c_acos");
    test_con(model, 2, {"[", "==", "[", "acosh", "[", "/", "[", "+", "ONE", std::to_string(7.389056), "]", std::to_string(5.436564), "]", "]", std::to_string(0.0), "]"}, "c_acosh");
    test_con(model, 3, {"[", "==", "[", "asin", "ZERO", "]", std::to_string(0.0), "]"}, "c_asin");
    test_con(model, 4, {"[", "==", "[", "asinh", "ZERO", "]", std::to_string(0.0), "]"}, "c_asinh");
    test_con(model, 5, {"[", "==", "[", "atan", "ZERO", "]", std::to_string(0.0), "]"}, "c_atan");
    test_con(model, 6, {"[", "==", "[", "atanh", "ZERO", "]", std::to_string(0.0), "]"}, "c_atanh");
    test_con(model, 7, {"[", "==", "[", "ceil", "ONE", "]", std::to_string(1.0), "]"}, "c_ceil");
    test_con(model, 8, {"[", "==", "[", "cos", "ZERO", "]", std::to_string(1.0), "]"}, "c_cos");
    test_con(model, 9, {"[", "==", "[", "cosh", "ZERO", "]", std::to_string(1.0), "]"}, "c_cosh");
    test_con(model, 10, {"[", "==", "[", "exp", "ZERO", "]", std::to_string(1.0), "]"}, "c_exp");
    test_con(model, 11, {"[", "==", "[", "floor", "ONE", "]", std::to_string(1.0), "]"}, "c_floor");
    test_con(model, 12, {"[", "==", "[", "log", "ONE", "]", std::to_string(0.0), "]"}, "c_log");
    test_con(model, 13, {"[", "==", "[", "log10", "ONE", "]", std::to_string(0.0), "]"}, "c_log10");
    test_con(model, 14, {"[", "==", "[", "sin", "ZERO", "]", std::to_string(0.0), "]"}, "c_sin");
    test_con(model, 15, {"[", "==", "[", "sinh", "ZERO", "]", std::to_string(0.0), "]"}, "c_sinh");
    test_con(model, 16, {"[", "==", "[", "sqrt", "ONE", "]", std::to_string(1.0), "]"}, "c_sqrt");
    test_con(model, 17, {"[", "==", "[", "tan", "ZERO", "]", std::to_string(0.0), "]"}, "c_tan");
    test_con(model, 18, {"[", "==", "[", "tanh", "ZERO", "]", std::to_string(0.0), "]"}, "c_tanh");
    }
  ...
  SECTION( "small15" ) {
    ...
    test_con(model, 0, {"[", "==", "[", "pow", "b.y", std::to_string(2.0), "]", std::to_string(4.0), "]"}, "CON1");
    }
