...
SECTION( "error1" ) {
    ...
    REQUIRE_THROWS_WITH(nlp.num_variables(),
            "Error accessing uninitialized NLPModel");
    REQUIRE_THROWS_WITH(nlp.num_objectives(),
            "Error accessing uninitialized NLPModel");
    REQUIRE_THROWS_WITH(nlp.num_constraints(),
            "Error accessing uninitialized NLPModel");
    ...
    REQUIRE_THROWS_WITH(nlp.print_equations(),
            "Error accessing uninitialized NLPModel");
    REQUIRE_THROWS_WITH(nlp.print_values(),
            "Error accessing uninitialized NLPModel");

    REQUIRE_THROWS_WITH(nlp.compute_f(),
            "Error accessing uninitialized NLPModel");
    double tmp3;
    REQUIRE_THROWS_WITH(nlp.compute_df(tmp3, tmp1, 0),
            "Error accessing uninitialized NLPModel");
    REQUIRE_THROWS_WITH(nlp.compute_c(tmp1),
            "Error accessing uninitialized NLPModel");
    REQUIRE_THROWS_WITH(nlp.compute_dc(tmp1, 0),
            "Error accessing uninitialized NLPModel");
    REQUIRE_THROWS_WITH(nlp.compute_H(tmp1, tmp1),
            "Error accessing uninitialized NLPModel");
    REQUIRE_THROWS_WITH(nlp.compute_J(tmp1),
            "Error accessing uninitialized NLPModel");
    }
