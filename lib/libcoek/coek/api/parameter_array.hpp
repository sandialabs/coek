...
inline ParameterArray parameter_array(size_t n)
{ return parameter(n); }
inline ParameterArray parameter_array(const std::vector<size_t>& shape)
...
{ return parameter(shape).name(name); }
inline ParameterArray parameter_array(const std::string& name, const std::initializer_list<size_t>& shape)
{ return parameter(shape).name(name); }
