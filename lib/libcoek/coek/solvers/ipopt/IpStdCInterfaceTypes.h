 ...
 */
typedef IpoptProblem (*CreateIpoptProblem_func_t)(
 ...
 */
typedef void (*FreeIpoptProblem_func_t)(
 ...
 */
typedef Bool (*AddIpoptStrOption_func_t)(
   IpoptProblem ipopt_problem,
   char*        keyword,
   char*        val
);
 ...
 * @return FALSE, if the option could not be set (e.g., if keyword is unknown)
 */
typedef Bool (*AddIpoptNumOption_func_t)(
   IpoptProblem ipopt_problem,
   char*        keyword,
   Number       val
);
 ...
 * @return FALSE, if the option  could not be set (e.g., if keyword is unknown)
 @*/
typedef Bool (*AddIpoptIntOption_func_t)(
   IpoptProblem ipopt_problem,
   char*        keyword,
   Int          val
);
 ...
 */
typedef Bool (*OpenIpoptOutputFile_func_t)(
   IpoptProblem ipopt_problem,
   char*        file_name,
   Int          print_level
);
 ...
 */
typedef Bool (*SetIpoptProblemScaling_func_t)(
   IpoptProblem ipopt_problem,
   Number       obj_scaling,
   Number*      x_scaling,
   Number*      g_scaling
...
typedef Bool (*SetIntermediateCallback_func_t)(
   IpoptProblem    ipopt_problem,
 ...
 */
typedef enum ApplicationReturnStatus (*IpoptSolve_func_t)(
