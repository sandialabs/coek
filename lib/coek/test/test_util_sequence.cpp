...
TEST_CASE("range_size_t", "[smoke]")
{
    SECTION("range_stop")
    {
        ...
        for (size_t i : coek::range<size_t>(4))
            test.push_back(i);
    ...
    {
        std::vector<size_t> test;
        for (size_t i : coek::range<size_t>(1, 4))
            test.push_back(i);
    ...
    {
        std::vector<size_t> test;
        for (size_t i : coek::range<size_t>(1, 9, 2))
            test.push_back(i);
...
TEST_CASE("sequence_size_t", "[smoke]")
{
    ...
    {
        std::vector<size_t> test;
        for (size_t i : coek::sequence<size_t>(1, 9, 2))
            test.push_back(i);
