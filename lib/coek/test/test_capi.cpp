...
TEST_CASE("capi_errors", "[smoke]")
{
    ...
    SECTION("variable")
    {
        ...
        REQUIRE_THROWS_AS(create_variable_array(0, 0, 0, false, false, 0.0, 1.0, 0.0, "A"),
                          std::runtime_error);
    }
}
...
TEST_CASE("capi_add_expression", "[smoke]")
{
    ...
    SECTION("Test nestedSum")
    {
        ...
        {
            apival_t e
                = expr_plus_expression(expr_plus_expression(a, b), expr_plus_expression(c, d));
    ...
    SECTION("Test nestedSum")
    {
        ...
        WHEN("e = 3*(2*(a+b)+c)")
        {
            apival_t e = expr_rtimes_int(
                3, expr_plus_expression(expr_rtimes_int(2, expr_plus_expression(a, b)), c));

            static std::list<std::string> baseline = {"[", "*", "3", "[", "+", "[", "*", "2", "[",
                                                      "+", "a", "b", "]", "]", "c", "]", "]"};
            REQUIRE(manager->expr_to_list(e, false) == baseline);
        }
    }
...
TEST_CASE("capi_minus_expression", "[smoke]")
{
    ...
    SECTION("Test nestedDiff")
    {
        ...
        {
            apival_t e
                = expr_minus_expression(expr_minus_expression(a, b), expr_minus_expression(c, d));
...
TEST_CASE("capi_mul_expression", "[smoke]")
{
    ...
    SECTION("Test nestedProduct")
    {
        ...
        {
            apival_t e
                = expr_times_expression(expr_times_expression(a, b), expr_times_expression(c, d));
    ...
    SECTION("Test nestedProduct2")
    {
        WHEN("e = (c+(a+b)) * ((a+b)+d)")
        {
            apival_t e1 = expr_plus_expression(a, b);
            apival_t e
                = expr_times_expression(expr_plus_expression(c, e1), expr_plus_expression(e1, d));
        ...
        WHEN("e = (c*(a+b)) * ((a+b)*d)")
        {
            apival_t e1 = expr_plus_expression(a, b);
            apival_t e
                = expr_times_expression(expr_times_expression(c, e1), expr_times_expression(e1, d));
...
TEST_CASE("capi_div_expression", "[smoke]")
{
    ...
    SECTION("Test constDivision")
    {
        ...
        WHEN("e = (a/b)/(c/d)")
        {
            apival_t e = expr_divide_expression(expr_divide_expression(a, b),
                                                expr_divide_expression(c, d));
