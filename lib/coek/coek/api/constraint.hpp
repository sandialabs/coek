...
Constraint operator<(size_t, const Parameter&);
Constraint operator<(size_t, const IndexParameter&);
Constraint operator<(size_t, const Variable&);
Constraint operator<(size_t, const Expression&);
Constraint operator<(const Parameter&, int);
Constraint operator<(const Parameter&, double);
Constraint operator<(const Parameter&, size_t);
...
Constraint operator<(const Variable&, size_t);
...
Constraint operator<(const IndexParameter&, size_t);
...
Constraint operator<(const Expression&, size_t);
