...
class LocalIndexedVariableTerm : public VariableTerm {
   ...
   public:
    // LocalIndexedVariableTerm(double _lb, double _ub, double _value, bool _binary, bool _integer,
    // bool _fixed, size_t _i, VariableArray* _varray)
    LocalIndexedVariableTerm(const expr_pointer_t& _lb, const expr_pointer_t& _ub,
                             const expr_pointer_t& _value, bool _binary, bool _integer, bool _fixed,
                             size_t _i, PythonVariableArray* _varray)
...
void initialize_index_map(std::vector<size_t>& dimen, std::vector<size_t>& tmp, std::size_t curr,
                          std::size_t& ctr, std::map<std::vector<size_t>, size_t>& index_map)
{
...
PythonVariableArray::PythonVariableArray(std::vector<size_t>& _dimen, std::string _name,
                                         double init, double lb, double ub, bool binary,
...
PythonVariableArray::PythonVariableArray(size_t n, std::string _name, double lb, double ub,
                                     ...
                                     bool integer, bool fixed)
{
    ...
    for (size_t i = 0; i < n; i++) {
        auto tmp
            = CREATE_POINTER(local::LocalIndexedVariableTerm, CREATE_POINTER(ConstantTerm, lb),
                             CREATE_POINTER(ConstantTerm, ub), CREATE_POINTER(ConstantTerm, init),
