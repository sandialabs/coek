...
class Model {
   ...
   public:
     ...
     * \param binary   a boolean flag that indicates whether the variable is boolean (default is \c
     * false) \param integer   a boolean flag that indicates whether the variable is a general
     * integer (default is \c false)
     *
     * \returns the variable object
     */
    Variable add_variable(double lb = -COEK_INFINITY, double ub = COEK_INFINITY,
                          double value = COEK_NAN, bool binary = false, bool integer = false);
    /** Create a variable and add it to the model with standard arguments.
     *
     ...
     * \returns the variable object
     */
    Variable add_variable(const std::string& name, double lb = -COEK_INFINITY,
                          double ub = COEK_INFINITY, double value = COEK_NAN, bool binary = false,
                          bool integer = false);
    /** Create a variable and add it to the model with standard arguments.
     *
     * This method accepts one or more standard options.
     ...
     * \returns the variable object
     */
    Variable add_variable(const Expression& lb, const Expression& ub, const Expression& value,
                          bool binary = false, bool integer = false);
    /** Create a variable and add it to the model with standard arguments.
     *
     * This method accepts one or more standard options.  The first argument is the
     ...
     * \returns the variable object
     */
    Variable add_variable(const std::string& name, const Expression& lb, const Expression& ub,
                          const Expression& value, bool binary = false, bool integer = false);
...
class CompactModel {
   ...
   public:
     ...
     */
    VariableMap add_variable(const Expression& lb, const Expression& ub, const Expression& value,
                             bool binary, bool integer, const SequenceContext& context);
    /** Create variables and add them to the model with standard arguments.
     *
     * This method accepts one or more standard options.
     * When default values are used, this specifies a continuous decision variable.
     ...
     * \returns a map to the objectives
     */
    VariableMap add_variable(const std::string& name, const Expression& lb, const Expression& ub,
     ...
     * \returns a map to the objectives
     */
    ObjectiveMap add_objective(const Expression& expr, const SequenceContext& context,
                               bool _sense = Model::minimize);
    /**
     * Create and add a sequence of objectives to the model.
     *
     ...
     * \returns a map to the objectives
     */
    ObjectiveMap add_objective(const std::string& name, const Expression& expr,
                               const SequenceContext& context, bool _sense = Model::minimize);
     ...
     * \returns a map to the constraints
     */
    ConstraintMap add_constraint(const std::string& name, const Constraint& expr,
                                 const SequenceContext& context);
