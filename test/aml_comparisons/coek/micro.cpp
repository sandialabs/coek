...
int main(int argc, char* argv[])
{
    ...
    if (name == "forloop") {
        double value = 0;
        for (size_t i = 0; i < size; ++i) value += 1.2;
        std::cout << "Value: " << value << " Size: " << size << std::endl;
    }
    else if (name == "range") {
        double value = 0;
        for (size_t i : coek::range<size_t>(size)) value += 1.2;
        std::cout << "Value: " << value << " Size: " << size << std::endl;
    }
    else if (name == "sequence") {
        double value = 0;
        for (size_t i : coek::sequence<size_t>(size)) value += 1.2;
        std::cout << "Value: " << value << " Size: " << size << std::endl;
    }
        ...
        for (size_t i = 0; i < size; ++i)
            for (size_t j = 0; j < size; ++j) value += 1.2;
        std::cout << "Value: " << value << " Size: " << size << std::endl;
    }
    else if (name == "nested-range") {
        double value = 0;
        for (size_t i : coek::range<size_t>(size))
            for (size_t j : coek::range<size_t>(size)) value += 1.2;
        std::cout << "Value: " << value << " Size: " << size << std::endl;
    }
    else if (name == "nested-sequence") {
        double value = 0;
        for (size_t i : coek::sequence<size_t>(size))
            for (size_t j : coek::sequence<size_t>(size)) value += 1.2;
        std::cout << "Value: " << value << " Size: " << size << std::endl;
    }
