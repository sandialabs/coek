...
coek::Expression f;
  ...
  SECTION( "Test trivialDivision" ) {
    ...
    WHEN( "e = r / 0" ) {
      coek::Expression e;
      REQUIRE_THROWS_WITH( r/0,
        "Division by zero.");
    }

    WHEN( "e = r / 0.0" ) {
      coek::Expression e;
      REQUIRE_THROWS_WITH( r/0.0,
        "Division by zero.");
    }
