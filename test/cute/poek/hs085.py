...
y3 = c2 / c3
y4 = 19.0 * y3
c4 = 0.04782 * (x[1] - y3) + 0.1956 * (x[1] - y3) ** 2.0 / x[2] + 0.6376 * y4 + 1.594 * y3
c5 = 100.0 * x[2]
c6 = x[1] - y3 - y4
c7 = 0.95 - c4 / c5
y5 = c6 * c7
...
c13 = 0.995 * y10 + 60.8 * x[2] + 48.0 * x[4] - 0.1121 * y14 - 5095.0
y15 = y13 / c13
...
model.add_constraint(y4 - 0.28 / 0.72 * y5 >= 0)
model.add_constraint(21 - 3496.0 * y2 / c12 >= 0)
model.add_constraint(62212.0 / c17 - 110.6 - y1 >= 0)
