    ...
    (
        (
            ...
            * (pw1**0.9904)
            ...
            + 0.64570846 * (aw1**0.3322) * (mf1**-1.5935) * (pw1**0.2363) * (s1l**0.1079)
    ...
    + (
        (
            ...
            * (pw2**0.9904)
            ...
            + 0.64570846 * (aw2**0.3322) * (mf2**-1.5935) * (pw2**0.2363) * (s2l**0.1079)
    ...
    + (
        (
            ...
            * (pw3**0.9904)
            ...
            + 0.49783215 * (aw3**0.3322) * (mf3**-1.5935) * (pw3**0.2363) * (s3l**0.1079)
...
model.add_constraint(
    tt1 - 1.2 * iw1 - 1.2 * pw1 - 1.2 * iw2 - 1.2 * pw2 - 1.2 * iw3 - 1.2 * pw3 - 1.2 * inw - 24.0
    >= 0.0
)
model.add_constraint(
    tt1 - 1.4 * iw1 - 1.4 * pw1 - 1.4 * iw2 - 1.4 * pw2 - 1.4 * iw3 - 1.4 * pw3 - 1.4 * inw - 28.0
    <= 0.0
)
